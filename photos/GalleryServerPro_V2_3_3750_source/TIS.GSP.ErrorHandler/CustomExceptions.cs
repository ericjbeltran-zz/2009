...
namespace GalleryServerPro.ErrorHandler.CustomExceptions
{
	...
	/// <summary>
	/// The exception that is thrown when the application or current request does not satisfy the requirements of the current license.
	/// </summary>
	[Serializable]
	public class InvalidLicenseException : Exception
	{
		...
		public InvalidLicenseException()
			: base(Resources.InvalidLicenseException_Ex_Msg) { }
		...
		/// innerException parameter is not a null reference, the current exception is raised in a catch
		/// block that handles the inner exception.</param>
		public InvalidLicenseException(string msg, Exception innerException)
			: base(msg, innerException) { }

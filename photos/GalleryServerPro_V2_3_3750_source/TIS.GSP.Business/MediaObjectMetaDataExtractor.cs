...
namespace GalleryServerPro.Business.Metadata
{
	...
	public class MediaObjectMetadataExtractor
	{
		...
		private static DateTime ConvertExifDateTimeToDateTime(string exifDateTime)
		{
			...
			// Replace the space in the middle with a colon so we can split the string into its componenent parts.
			exifDateTime = String.Concat(exifDateTime.Substring(0, 10), ":", exifDateTime.Substring(11));

...
namespace GalleryServerPro.Business
{
	...
	public static class SecurityManager
	{
		...
		/// <summary>
		/// Verifies the current request can be completed given the existing license rules. Throws an exception when the license is being violated.
		/// </summary>
		/// <param name="isLocalRequest">If set to <c>true</c> the current request originates from the same machine as the server-side logic.</param>
		/// <exception cref="GalleryServerPro.ErrorHandler.CustomExceptions.InvalidLicenseException">Thrown when the current request violates the existing license rules.</exception>
		/// <remarks>The base implementation of GalleryServer Pro does not implement this method, and thus never throws an exception. Branched or derived versions
		/// of this code base may choose to implement this method when there are tighter licensing requirements, such as the DotNetNuke module.</remarks>
		public static void VerifyLicense(bool isLocalRequest)
		{
			// Not implemented
		}

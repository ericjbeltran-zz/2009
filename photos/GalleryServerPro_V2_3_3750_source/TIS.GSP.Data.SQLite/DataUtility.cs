...
namespace GalleryServerPro.Data.SQLite
{
	...
	internal static class DataUtility
	{
		...
		/// <summary>
		/// Imports the data in <paramref name="galleryData"/> to the SQLite database specified in <paramref name="connectionString"/>.
		/// </summary>
		...
		internal static void ImportData(string galleryData, bool importMembershipData, bool importGalleryData, string connectionString)
		{
		...
		internal static string ExportData(bool exportMembershipData, bool exportGalleryData, string connectionString)
		{

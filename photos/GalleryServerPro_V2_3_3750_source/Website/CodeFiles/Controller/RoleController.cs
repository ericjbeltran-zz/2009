...
namespace GalleryServerPro.Web.Controller
{
    ...
    public static class RoleController
    {
        ...
        private static string CacheKeyNameForRoles
        {
            get
            {
                return String.Concat(HttpContext.Current.Session.SessionID, "_", Util.UserName, "_Roles"); ;
            }
        }
        ...
        {
            RoleGsp.AddUsersToRoles(new string[] { userName }, new string[] { roleName.Trim() });
        }
        ...
        {
            RoleGsp.RemoveUsersFromRoles(new string[] { userName }, new string[] { roleName.Trim() });
        }
        ...
        public static void RemoveRolesFromCache()
        {
            ...
            {
                rolesCache.Remove(CacheKeyNameForRoles);
            }
        }

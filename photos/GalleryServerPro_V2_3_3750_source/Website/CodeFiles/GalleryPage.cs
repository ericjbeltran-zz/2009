...
namespace GalleryServerPro.Web.Pages
{
	...
	public abstract class GalleryPage : UserControl
	{
		...
		protected void GalleryPage_Init(object sender, System.EventArgs e)
		{
			...
			if (Util.IsAuthenticated && this.Core.EnableUserAlbum)
			{
				UserController.ValidateUserAlbum(Util.UserName);
			}
		...
		protected override void Render(System.Web.UI.HtmlTextWriter writer)
		{
			...
			// If needed, add web service call to invoke maintenance routine.
			AddMaintenanceServiceCall();
		...
		private void AddMaintenanceServiceCall()
		{
...
{
	Gsp.Gallery.PerformMaintenance();
}";

...
namespace GalleryServerPro.Web.gs.pages
{
	...
	public partial class install : System.Web.UI.UserControl
	{
		...
		private bool AreProvidersSpecifiedInWebConfig()
		{
			...
			return ((wce.MembershipDefaultProvider.Equals(membershipProviderName, StringComparison.OrdinalIgnoreCase))
							&& (wce.RoleDefaultProvider.Equals(roleProviderName, StringComparison.OrdinalIgnoreCase))
							&& (wce.ProfileDefaultProvider.Equals(profileProviderName, StringComparison.OrdinalIgnoreCase)));
		}
